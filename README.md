...
- Расчёт идёт на процессоре вашего устройства, поэтому картинка на входе ограничена ~1,2 мегапикселя (примерно 1200×1000). Картинки побольше лучше сначала обрезать.
- Чем крупнее картинка, тем дольше расчёт — вплоть до пары минут.
